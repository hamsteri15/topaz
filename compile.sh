...
#hipcc -std=c++14 -Iinclude/ -Itest/ -x cu test/test.cpp -o test_gpu.bin
...
#nvcc -Iinclude/ -Itest/ -x cu test/benchmark.cpp -o benchmark_gpu_nvcc.bin
#hipcc -Iinclude/ -Itest/ -x cu test/benchmark.cpp -o benchmark_gpu_hip.bin
#clang++ -Iinclude/ -Itest/ test/benchmark.cpp -o benchmark_cpu.bin
